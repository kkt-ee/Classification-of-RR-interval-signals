function mi = mutual(signal,filename,partitions,tau)
...
if nargout == 0
    ...
    filename=strcat(filename,' Mutual Information Test (first local minimum)')%remove
    %fname = '/home/k/workbench/MTech_Research/SIGNALPROCESSING/RQA_underConstruction/step2_RQA/fig_RQAplots/';%remove
