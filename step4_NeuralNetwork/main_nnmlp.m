...
function Tnnresults= main_nnmlp(xlsxfile,sheetname,hiddenNeurons,a,b,impPredictors)
%clc;
%clear all;
close all;
nntraintool('close')
...
for i=1:numel(ridx)
    ...
    [PerfTrain, PerfTest, PerfValidate,PerfTotal] = nnmlp(xlsxfile,sheetname,impPredictors,a,b,NNparam,k);        % fUNCTION call: nnmlp()
